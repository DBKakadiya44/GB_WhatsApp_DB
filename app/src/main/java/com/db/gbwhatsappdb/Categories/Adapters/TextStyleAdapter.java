...
public class TextStyleAdapter extends RecyclerView.Adapter<TextStyleAdapter.ViewHolder>
{
    ...
    public TextStyleAdapter(Context context, String[] strArr, String str) {
        this.items = strArr;
        this.ctx = context;
        this.tab_string = str;
    }
    ...
    @NonNull
    @Override
    public TextStyleAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cap_list,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TextStyleAdapter.ViewHolder holder, int position) {
